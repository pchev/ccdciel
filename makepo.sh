...
rstconv -i src/units/x86_64-linux-qt6/u_translation.rsj -o data/language/ccdciel.pot
/home/compiler/lazarus/tools/updatepofiles data/language/ccdciel.pot
/home/compiler/lazarus/tools/updatepofiles data/language/ccdciel.pot

rstconv -i src/units/x86_64-linux-qt6/u_hints.rsj -o data/language/ccdciel_hints.pot
