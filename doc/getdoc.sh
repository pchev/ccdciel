...
wget -E -p -np -nH --cut-dirs=1 -X */*detail,*/*export,*/playground -R *do=index* -P doc --restrict-file-names=windows -k http://www.ap-i.net/ccdciel/en/start http://www.ap-i.net/ccdciel/en/start --header="X-DokuWiki-Do: export_xhtml"
