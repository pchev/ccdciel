...
install -v -m 644 scripts/astrometry.sh  $destdir/share/ccdciel/scripts/astrometry.sh 
install -v -m 644 scripts/astrometry-online.sh  $destdir/share/ccdciel/scripts/astrometry-online.sh 
install -v -m 644 scripts/astrometry-macos.sh  $destdir/share/ccdciel/scripts/astrometry-macos.sh 
