...
iconlist=(adjust bullseye capture center clipping-info focus hist histdec pin plan video inf invert flip-horizontal flip-vertical show-images gear zoom-hist)
