...
install -v -m 644 data/language/ccdciel.lo.po   $destdir/data/language/ccdciel.lo.po
...
install -v -m 644 data/language/ccdciel_hints.lo.po   $destdir/data/language/ccdciel_hints.lo.po
