...
unzip -d $destdir/scripts/python system_integration/Windows/data/python-requests.zip
...
install -v -m 755 scripts/siril_light.script $destdir/scripts/siril_light_color.script
