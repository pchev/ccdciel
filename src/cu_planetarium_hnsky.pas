...
procedure TPlanetarium_hnsky.Connect(cp1,cp2,cp3,cp4: string; cb1:boolean=False);
begin
...
procedure TPlanetarium_hnsky.Show;
begin
end;
...
procedure TPlanetarium_hnsky.ShowAstrometry(sra,sde: double);
begin
  // todo
end;

procedure TPlanetarium_hnsky.ClearData;
begin
  FRecvData:='';
  Fra:=NullCoord;
  Fde:=NullCoord;
