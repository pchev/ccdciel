...
function T_autoguider_dither.GetLockPosition(out x,y:double):boolean;
begin
  result:=false;
end;
...
function T_autoguider_dither.GetSettling: boolean;
begin
  result:=false;
end;

function T_autoguider_dither.GetPaused: boolean;
begin
  result:=false;
end;

function T_autoguider_dither.SpectroSetGuideStar(GuideRa,GuideDec:double): Boolean;
begin
  result:=true;
end;

function T_autoguider_dither.SpectroSetTarget(TargetRa,TargetDec: double):Boolean;
begin
  result:=true;
end;
