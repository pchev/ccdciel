...
begin
  ...
  if not f.Header.Valueof('DATE-OBS',hdateobs) then begin
    hdateobs:=FormatDateTime(dateiso,NowUTC-Fexptime/secperday);
    msg('DATE-OBS keyword not found in header, use exposure start time instead.',1);
  end;
